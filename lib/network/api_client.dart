...
import 'package:softtic_assessment/utils/app_logger_util.dart';
...
class ApiClient {
  ...
  static Future<dynamic> upload(
    ...
    try {
      Dio dio = await _dioClient(isTokenRequired,true);
  ...
  static Future<Dio> _dioClient(bool isTokenRequired,bool isImageUpload) async {
    String token = await SharedPrefUtil.getString("isLoggedIn");
    if (isTokenRequired) {
